...
const brandStories = [
  { name: "MONO LANE", title: "Quiet Essential", image: "images/1521572163474-6864f9cf17ab.jpg", copy: "일상에서 가장 자주 입는 기본 아이템을 간결한 실루엣으로 제안합니다." },
  { name: "STUDIO LOW", title: "Soft Utility", image: "images/1516826957135-700dedea698c.jpg", copy: "편안한 소재와 낮은 채도의 컬러로 오래 입는 데일리웨어를 만듭니다." },
  { name: "VOID ARCHIVE", title: "Urban Outerwear", image: "images/1543076447-215ad9ba6923.jpg", copy: "도시적인 레이어링에 어울리는 아우터와 테크 소재를 중심으로 전개합니다." },
  { name: "NEAT FIELD", title: "Tailored Casual", image: "images/1473966968600-fa801b869a1a.jpg", copy: "팬츠와 셋업 중심의 단정한 캐주얼을 큐레이션합니다." }
];
...
function gallery(product) {
  ...
  return [product.image, ...(map[product.category] || [])].slice(0, 3);
}
